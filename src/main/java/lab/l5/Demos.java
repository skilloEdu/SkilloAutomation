...
public class Demos {
    ...
    public static void testArrayDeclarationElementInit() {
        ...
        System.out.println(carBrands[0]); // Prints element by index
        System.out.println(evenNumbers[2]); // Prints element by index
        System.out.println(degrees[5]); // Prints element by index

        System.out.println(carBrands.length); // Returns array length as integer
    ...
    public static void testArrayDeclaration() {
        ...
        String[] cars = new String[3]; //creates empty array with size 3 elements
        cars[0] = "Volvo";
        cars[1] = "Bmw";
        cars[2] = "Mercedes";
    ...
    public static void testArrayElementValue() {
        String[] carBrands = {"Audi", "Bmw", "Volvo", "Mercedes"};
        carBrands[1] = "Karuca"; //replaces the value in index one with Karuca
...
/*        int[][] arr=new int[3][3];//3 row and 3 column
    ...
    public static void testArrayListDeclaration() {
        ...
        cars.add("Volvo");
        cars.add("BMW"); // Adds element to the array list
        cars.add("Ford");
        cars.add("Mazda");
        System.out.println(cars);
        System.out.println(cars.get(0)); // Prints element with index 0
    }
    ...
    public static void testArrayListOperations() {
        ...
        cars.add("Ford");
        cars.add("Mazda");
        cars.set(1, "Mercedes"); //change element with index 1 to new value
    ...
    public static void testStack() {
        ...
        elements.push("Test1"); // Adds element to the stack
        elements.push("Test2");
        elements.push("Test3");
        elements.push("Test4");
        ...
        System.out.println("Element removed: " + elements.pop()); // removes Test4 from the stack
        System.out.println("Stack elements: " + elements);
    ...
    public static void testHashSetIterator() {
        ...
        set.add("One"); //Adds element to the hash set
        set.add("Two");
        set.add("Three");
        set.add("Four");
        set.add("Five");
    ...
    public static void testHashSetOperations() {
        ...
        set1.add("Ekaterina");
        set1.add("Maya");
        set.addAll(set1); //Adds set1 element in set
    ...
    public static void testHashMapEntrySet() {
        ...
        //Put elements in Map
        map.put(1, "Mango"); //adds element to hashmap
        map.put(2, "Apple");
        map.put(3, "Banana");
        map.put(4, "Grapes");

        System.out.println("Iterating Hashmap...");
        for (Map.Entry m : map.entrySet()) {//Map entry returns key-value pairs
