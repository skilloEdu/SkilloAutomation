...
public class Exercises {
    public static void main(String[] args) {
        Person person = new Person("Dimitar", 'm', "orthodox", "Bulgarian", "Manager", "Bulgarian","8103245060","Bulgaria");
        Italian italian = new Italian("Francesco", 'm', "catholic", "Developer", "7605108945", "Italy");
        Bulgarian bulgarian = new Bulgarian("Ivanka", 'f', "orthodox", "unemployed", "9112239583","Bulgaria");
        American american = new American("John", 'm', "catholic", "Boss", "6811125584","USA");
        Child child = new Child("Ivancho", 'm', "orthodox", "Bulgarian", "Bulgaria", "9912239583", "Bulgaria");
